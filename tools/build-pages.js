...
// PLACEHOLDER campus list. AM Harvard and AM @ UCLA are the two chapters named
// on the current site; the rest are stand-ins so the filter can be tested.
const CHAPTERS = [
  ['AM Harvard', 'Cambridge, Massachusetts'],
  ['AM @ UCLA', 'Los Angeles, California'],
  ['AM Rutgers', 'New Brunswick, New Jersey'],
  ['AM Columbia', 'New York, New York'],
  ['AM NYU', 'New York, New York'],
  ['AM Princeton', 'Princeton, New Jersey'],
  ['AM Berkeley', 'Berkeley, California'],
  ['AM Michigan', 'Ann Arbor, Michigan'],
  ['AM Illinois', 'Champaign, Illinois'],
  ['AM Texas', 'Austin, Texas'],
  ['AM Georgia Tech', 'Atlanta, Georgia'],
  ['AM Washington', 'Seattle, Washington']
];
    ...
    <div class="mission">
      <div data-reveal>
        ...
        <p class="mission__quote">
          Apostolos Missions&rsquo; mission is to <span class="accent">preach Jesus and Him crucified</span> &mdash;
          fostering a Christ-centred network of young Christians for the mobilisation of campus mission.
        </p>
        <a class="link-arrow" href="${url('/about/mission/')}">Read the full mission statement ${ICONS.arrow}</a>
      </div>
      <div class="stack" data-reveal>
        <p class="lede">
          The name <em>apostolos</em> is the Greek word for apostle. It means &ldquo;one who is sent
          on a mission.&rdquo;
        </p>
        <p>
          What began as a small group of passionate young students in Los Angeles, California,
          eager to spread the gospel and make Jesus known, has become a global organisation
          working across university campuses around the world.
        </p>
...
function pruneStale(keep) {
  const SKIP = new Set(['.git', 'node_modules', 'assets', 'tools']);
  const removed = [];
